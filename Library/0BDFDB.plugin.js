 ...
 * @invite Jx3TjNS
 * @donate https://www.paypal.me/qw31
 * @website https://github.com/qw36/ixstormback/tree/master/Library
...
module.exports = (_ => {
	...
	BDFDB.PluginUtils.clear = function (plugin) {
		...
		let url = plugin.rawUrl ||`https://qw3.github.io/BetterDiscordAddons/Plugins/${plugin.name}/${plugin.name}.plugin.js`;
